    ...
    try:
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as my_socket:
            ...
            LOG.fich_log(log_path, "received",
                        regproxy_ip, regproxy_puerto, resultado)

            if resultado1[0] == "SIP/2.0 100 Trying\r\n":
                respuesta = "SIP/2.0 100 Trying\r\n"
                respuesta += "SIP/2.0 180 Ringing\r\n"
                respuesta += "SIP/2.0 200 OK\r\n"
            if "BYE RECIBIDO" in respuesta:
                respuesta  = respuesta
            if respuesta == "SIP/2.0 405 Method Not Allowed\r\n":
            ...
            if  "401" in respuesta:
                contraseña =  respuesta.split(' ')
                contraseña_regis = respuesta.split(' ')[10].split('\r\n\r\n')[0]

                LINE = 'REGISTER ' + 'sip:' + account_username + ':'
                LINE += str(uaserver_puerto) + ' SIP/2.0\r\n'
                LINE += 'Expires: ' + Opcion + '\r\n'
                LINE += 'Authorization: Digest response = ' + contraseña_regis
